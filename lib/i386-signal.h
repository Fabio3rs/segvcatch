    ...
    do {                                                                        \
        ...
        */                                                                      \
        ...
        if (_eip[0] == 0xf7) {                                                  \
            ...
            {                                                                   \
                _min_value_dividend = _gregs[REG_EAX] == (greg_t)0x80000000UL;  \
            }                                                                   \
                                                                                \
...
#define INIT_SIGILL                                                            \
    do {                                                                       \
        struct kernel_sigaction act;                                           \
        act.k_sa_sigaction = _Jv_catch_sigill;                                 \
        sigemptyset(&act.k_sa_mask);                                           \
        act.k_sa_flags = SA_SIGINFO | 0x4000000;                               \
        act.k_sa_restorer = restore_rt;                                        \
        syscall(SYS_rt_sigaction, SIGILL, &act, NULL, _NSIG / 8);              \
    } while (0)
